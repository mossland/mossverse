...
import { StakePoolSchema, StakePoolInput } from "./stakePool.gql";
...
interface DocMtds extends dbConfig.DefaultDocMtds<Doc> {
  addStaking: (userId: Id, value: number, expireAt?: Date) => Doc;
  getReward: (userId: Id) => number;
}
schema.methods.dumb = function (this: Doc) {
  return this;
};
schema.methods.addStaking = function (this: Doc, userId: Id, value: number, expireAt?: Date) {
