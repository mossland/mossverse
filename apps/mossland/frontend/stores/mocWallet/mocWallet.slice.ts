...
const state = (setget, suffix: string) => ({
  ...createState(gql.mocWalletGraphQL),
  ...createActions(gql.mocWalletGraphQL, setget, suffix),
});
...
export type MocWalletSliceState = Get<typeof state, typeof actions>;
export type MocWalletSlice = Slice<"mocWallet", MocWalletSliceState>;
