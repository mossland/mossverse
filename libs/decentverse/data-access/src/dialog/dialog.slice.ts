...
const state = (setget, suffix: string) => ({
  ...createState(gql.dialogGraphQL),
  ...createActions(gql.dialogGraphQL, setget, suffix),
});
...
export type DialogSliceState = Get<typeof state, typeof actions>;
export type DialogSlice = Slice<"dialog", DialogSliceState>;
