...
const state = (setget, suffix: string) => ({
  ...createState(gql.mapGraphQL),
  ...createActions(gql.mapGraphQL, setget, suffix),
});
...
export type MapSliceState = Get<typeof state, typeof actions>;
export type MapSlice = Slice<"map", MapSliceState>;
