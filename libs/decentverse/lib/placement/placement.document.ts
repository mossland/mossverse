...
import { PlacementInput, PlacementSchema } from "./placement.constant";
import { Schema, SchemaFactory } from "@nestjs/mongoose";
import { dbConfig } from "@util/server";
@Schema(dbConfig.defaultSchemaOptions)
class Placement extends PlacementSchema {}
export const name = Placement.name;
export type Input = PlacementInput;
export type Raw = Placement;
