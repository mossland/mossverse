...
import { WebviewInput, WebviewSchema } from "./webview.constant";
import { dbConfig } from "@util/server";
@Schema(dbConfig.defaultSchemaOptions)
class Webview extends WebviewSchema {}
export const name = Webview.name;
export type Input = WebviewInput;
export type Raw = Webview;
