import { CollisionInput, CollisionSchema } from "./collision.constant";
import { Document, Model, Query, Schema as Sch, Types } from "mongoose";
import { Schema, SchemaFactory } from "@nestjs/mongoose";
import { dbConfig } from "@util/server";
@Schema(dbConfig.defaultSchemaOptions)
class Collision extends CollisionSchema {}
export const name = Collision.name;
export type Input = CollisionInput;
export type Raw = Collision;
