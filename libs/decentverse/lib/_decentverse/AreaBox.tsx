  ...
  return (
    <div className="flex justify-center items-center w-full h-[100px]">
      ...
      >
        ...
        <div className="absolute w-1 h-1 -translate-x-1/2 -translate-y-1/2 bg-black rounded-full top-1/2 left-1/2" />
        <div className="absolute pt-4 -translate-x-1/2 -translate-y-1/2 rounded-full top-1/2 left-1/2">
