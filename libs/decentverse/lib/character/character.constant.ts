...
import { Sprite, SpriteInput, SpriteSchema } from "../_decentverse/decentverse.constant";
...
@ObjectType()
export class Character extends IntersectionType(BaseField(Base), Tail) {}
@Schema()
