import { CharacterInput, CharacterSchema } from "./character.constant";
import { Document, Model, Query, Schema as Sch, Types } from "mongoose";
import { Schema, SchemaFactory } from "@nestjs/mongoose";
import { dbConfig } from "@util/server";
@Schema(dbConfig.defaultSchemaOptions)
class Character extends CharacterSchema {}
export const name = Character.name;
export type Input = CharacterInput;
export type Raw = Character;
