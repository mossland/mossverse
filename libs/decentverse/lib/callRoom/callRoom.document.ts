import { CallRoomInput, CallRoomSchema } from "./callRoom.constant";
import { Document, Model, Query, Schema as Sch, Types } from "mongoose";
import { Schema, SchemaFactory } from "@nestjs/mongoose";
import { dbConfig } from "@util/server";
@Schema(dbConfig.defaultSchemaOptions)
class CallRoom extends CallRoomSchema {}
export const name = CallRoom.name;
export type Input = CallRoomInput;
export type Raw = CallRoom;
