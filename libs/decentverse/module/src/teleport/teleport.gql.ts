...
class Tail extends Base {
  @Field(() => String)
  @Prop({ type: String, enum: cnst.teleportStatuses, required: true, default: "active" })
  status: cnst.TeleportStatus;
}

// * 최종 생성 모델
@InputType()
export class TeleportInput extends IntersectionType(InputOverwrite, Base, InputType) {}
@ObjectType()
export class Teleport extends IntersectionType(BaseGql(Base), Tail) {}
@Schema()
export class TeleportSchema extends Tail {}
