...
export const Inventory = ({ socket }: InventoryProps) => {
  // const inventory = inventoryStore.use.inventory();
  // const isOpenInventory = inventoryStore.use.isOpenInventory();
  // const toggleOpenInventory = inventoryStore.use.toggleOpenInventory();
  // const syncInventory = inventoryStore.use.syncInventory();
  const initMyItems = userStore.use.initMyItems();
  const myItems = userStore.use.myItems();
  const isInventoryOpen = userStore.use.isInventoryOpen();
  const self = userStore.use.self();
  const openInventory = () => userStore.setState({ isInventoryOpen: true });
  const closeInventory = () => userStore.setState({ isInventoryOpen: false });
