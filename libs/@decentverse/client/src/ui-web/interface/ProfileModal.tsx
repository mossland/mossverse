...
export const ProfileModal = () => {
  ...
  const render = worldStore.use.me();
  const isPossibleEdit = userStore.use.isPossibleEdit();
  const isProfileNameEdit = userStore.use.isProfileNameEdit();

  const closeProfile = () => userStore.setState({ user: null, isPossibleEdit: false });
              ...
              {isProfileNameEdit ? (
                ...
                <div className="name">
                  ...
                  {isMe() && user.role !== "guest" && (
                    <div className="name-button" onClick={() => userStore.setState({ isProfileNameEdit: true })}>
                      <BiEdit />
                    </div>
                  )}
                </div>
