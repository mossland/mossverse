...
import { ListingSchema, ListingInput } from "./listing.gql";
...
interface DocMtds extends dbConfig.DefaultDocMtds<Doc> {
  isPurchaseWith: (type: "thing" | "token", tag: gql.PriceTagInput) => boolean;
  isPurchaseable: () => boolean;
}
schema.methods.isPurchaseWith = function (this: Doc, type: "thing" | "token", tag: gql.PriceTagInput) {
  return !!(
    tag[type] &&
