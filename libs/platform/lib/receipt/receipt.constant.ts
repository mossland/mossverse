...
import { Listing } from "../listing/listing.constant";
import { Prop, Schema } from "@nestjs/mongoose";
import { Raffle } from "../raffle/raffle.constant";
import { Trade } from "../trade/trade.constant";
...
@ObjectType()
export class Receipt extends BaseField(Tail) {}
@Schema()
