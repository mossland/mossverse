...
import { ReceiptInput, ReceiptSchema } from "./receipt.constant";
import { Schema, SchemaFactory } from "@nestjs/mongoose";
import { dbConfig } from "@util/server";
@Schema(dbConfig.defaultSchemaOptions)
class Receipt extends ReceiptSchema {}
export const name = Receipt.name;
export type Input = ReceiptInput;
export type Raw = Receipt;
