...
import { ShipInfoInput, ShipInfoSchema } from "./shipInfo.constant";
import { dbConfig } from "@util/server";
@Schema(dbConfig.defaultSchemaOptions)
class ShipInfo extends ShipInfoSchema {}
export const name = ShipInfo.name;
export type Input = ShipInfoInput;
export type Raw = ShipInfo;
