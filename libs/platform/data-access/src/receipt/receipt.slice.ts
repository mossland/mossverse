...
const state = (setget, suffix: string) => ({
  ...createState(gql.receiptGraphQL),
  ...createActions(gql.receiptGraphQL, setget, suffix),
});
...
export type ReceiptSliceState = Get<typeof state, typeof actions>;
export type ReceiptSlice = Slice<"receipt", ReceiptSliceState>;
