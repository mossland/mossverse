import { Listing, ListingSummary } from "./listing.gql";
import { baseLocale, Locale } from "@shared/util-client";

export const listingLocale = {
  ...baseLocale,
  user: ["User", "사용자"],
  type: ["Type", "유형"],
  wallet: ["Wallet", "지갑"],
...
export type ListingLocale = Locale<"listing", Listing & ListingSummary, typeof listingLocale>;
