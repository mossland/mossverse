...
import { Field, Float, ID, InputType, Int, IntersectionType, ObjectType, PartialType, PickType } from "@nestjs/graphql";
import { Prop, Schema } from "@nestjs/mongoose";
import { Thing } from "../thing/thing.constant";
import { Token } from "../token/token.constant";
...
@ObjectType()
export class Ownership extends IntersectionType(BaseField(Base), Tail) {}
@Schema()
