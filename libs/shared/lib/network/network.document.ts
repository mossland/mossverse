...
import { NetworkInput, NetworkSchema } from "./network.constant";
import { Schema, SchemaFactory } from "@nestjs/mongoose";
import { dbConfig } from "@util/server";
@Schema(dbConfig.defaultSchemaOptions)
class Network extends NetworkSchema {}
export const name = Network.name;
export type Input = NetworkInput;
