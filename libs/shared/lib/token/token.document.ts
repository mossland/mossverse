...
import { TokenInput, TokenSchema } from "./token.constant";
import { dbConfig } from "@util/server";
@Schema(dbConfig.defaultSchemaOptions)
class Token extends TokenSchema {}
export const name = Token.name;
export type Input = TokenInput;
export type Raw = Token;
