...
const state = (setget, suffix: string) => ({
  ...createState(gql.walletGraphQL),
  ...createActions(gql.walletGraphQL, setget, suffix),
});
...
export type WalletSliceState = Get<typeof state, typeof actions>;
export type WalletSlice = Slice<"wallet", WalletSliceState>;
