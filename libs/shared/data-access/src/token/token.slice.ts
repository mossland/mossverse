...
const state = (setget, suffix: string) => ({
  ...createState(gql.tokenGraphQL),
  ...createActions(gql.tokenGraphQL, setget, suffix),
});
...
export type TokenSliceState = Get<typeof state, typeof actions>;
export type TokenSlice = Slice<"token", TokenSliceState>;
