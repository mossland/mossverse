...
//*=================================================================*//
//*====================== Wallet Signing Area ======================*//
export type GetKeyringIdHasWalletQuery = { getKeyringIdHasWallet: string | null };
...
export const getKeyringIdHasWallet = async (networkId: string) =>
  (await query<GetKeyringIdHasWalletQuery>(getKeyringIdHasWalletQuery, { networkId })).getKeyringIdHasWallet;
...
export const signupWallet = async (networkId: string, keyringId?: string) =>
  crystalizeKeyring((await mutate<SignupWalletMutation>(signupWalletMutation, { networkId, keyringId })).signupWallet);
...
export type GetKeyringIdHasAccountIdQuery = { getKeyringIdHasAccountId: string | null };
...
export const getKeyringIdHasAccountId = async (accountId: string) =>
  (await query<GetKeyringIdHasAccountIdQuery>(getKeyringIdHasAccountIdQuery, { accountId })).getKeyringIdHasAccountId;
...
export const signaddPassword = async (accountId: string, password: string, token: string) =>
  crystalizeKeyring(
    (await mutate<SignaddPasswordMutation>(signaddPasswordMutation, { accountId, password, token })).signaddPassword
  );
...
export const changePassword = async (password: string, prevPassword: string, token: string) =>
  (await mutate<ChangePasswordMutation>(changePasswordMutation, { password, prevPassword, token })).changePassword;

export type ChangePasswordWithPhoneMutation = { changePasswordWithPhone: boolean };
...
export type AddPhoneInPrepareKeyringMutation = { addPhoneInPrepareKeyring: Keyring };
...
export type AddPhoneInActiveKeyringMutation = { addPhoneInActiveKeyring: Keyring };
...
export const requestPhoneCode = async (keyringId: string, phone: string, hash: string) =>
  dayjs(
    (await mutate<requestPhoneCodeMutation>(requestPhoneCodeMutation, { keyringId, phone, hash })).requestPhoneCode
  );
...
export const verifyPhoneCode = async (keyringId: string, phone: string, phoneCode: string) =>
  crystalizeKeyring(
    (await mutate<verifyPhoneCodeMutation>(verifyPhoneCodeMutation, { keyringId, phone, phoneCode })).verifyPhoneCode
  );
...
export const signupPhone = async (keyringId: string, phone: string, phoneCode: string) =>
  crystalizeKeyring(
    (await mutate<SignupPhoneMutation>(signupPhoneMutation, { keyringId, phone, phoneCode })).signupPhone
  );
...
export const signaddPhone = async (phone: string, phoneCode: string) =>
  crystalizeKeyring((await mutate<SignaddPhoneMutation>(signaddPhoneMutation, { phone, phoneCode })).signaddPhone);
...
export const signinPhone = async (keyringId: string, phone: string, phoneCode: string) =>
  (await mutate<SigninPhoneMutation>(signinPhoneMutation, { keyringId, phone, phoneCode })).signinPhone.jwt;
//*====================== Phone Signing Area ======================*//
//*================================================================*//
