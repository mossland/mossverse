...
const state = (setget, suffix: string) => ({
  ...createState(gql.ownershipGraphQL),
  ...createActions(gql.ownershipGraphQL, setget, suffix),
});
...
export type OwnershipSliceState = Get<typeof state, typeof actions>;
export type OwnershipSlice = Slice<"ownership", OwnershipSliceState>;
