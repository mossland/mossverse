...
export interface ERC721AOwnersExplicitInterface extends utils.Interface {
  functions: {
...
export interface ERC721AOwnersExplicit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721AOwnersExplicitInterface;
