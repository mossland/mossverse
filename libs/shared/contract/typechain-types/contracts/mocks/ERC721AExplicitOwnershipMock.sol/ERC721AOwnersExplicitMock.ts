...
export interface ERC721AOwnersExplicitMockInterface extends utils.Interface {
  functions: {
...
export interface ERC721AOwnersExplicitMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721AOwnersExplicitMockInterface;
