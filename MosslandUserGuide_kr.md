...
1) 지갑 로그인: 이 옵션을 선택하면 카이카스 지갑과 메타마스크 지갑을 사용하여 로그인할 수 있습니다.

2) 게스트 로그인: 게스트 로그인은 일부 기능에 제한이 있지만 메타버스를 간단하게 체험할 수 있는 옵션입니다.
...
화면 왼쪽 하단에 위치한 드래그 버튼을 사용하여 캐릭터 이동을 조작합니다. 메타버스 내에서 특수 기능이 있는 건물 근처로 다가갈 때, 화면에 ‘Press’라는 안내 UI가 표시됩니다. 동시에, 오른쪽 하단에는 말머리 모양의 기능 활성화 버튼이 나타납니다. 이 버튼을 눌러 원하는 기능을 활성화할 수 있습니다.
...
#### 1) 텍스트 채팅
이 옵션은 텍스트를 입력할 수 있는 영역(1번)과 다른 사용자들의 채팅 내용이 표시되는 채팅창(2번)을 포함합니다.
...
메타버스 맵을 탐험하다 보면 화상 및 음성 채팅이 활성화되는 특정 장소가 있습니다. 이 장소에서는 헤드폰과 마이크 표시를 on/off 하여 다른 사용자들과 화상 및 음성 채팅을 할 수 있습니다.
...
다만, 이 무료 충전 기능은 사용자의 보유 포인트가 1000포인트 이하일 때에만 활성화됩니다.
...
게임 센터에는 미니 게임을 즐길 수 있습니다. 현재는 간단하면서도 재미있는 가위바위보 게임이 제공되고 있습니다. 누구나 쉽게 즐길 수 있으며,
게임을 즐기기 위해서는 포인트가 필요합니다.
포인트는 위의 안내된 내용처럼 무료로 충전할 수 있어 모든 사용자가 게임을 자유롭게 즐길 수 있습니다.
...
상점에서는 기프티콘 등 다양한 상품을 구매할 수 있으며, 현재 판매 중인 상품들은 각각 고유한 특징과 내용을 가지고 있습니다. 사용자들은 이러한 다양한 옵션 중에서 선택하여 구매할 수 있습니다.
...
다만, 상품의 타입에 따라 인벤토리에서 확인 가능한 것이 다를 수 있습니다.
...
모든 메타버스 사용자들은 자신이 제작한 캐릭터 스킨을 상점에 등록하고 판매할 수 있습니다. 다만, 스킨 등록은 검수를 거쳐 승인을 받아야 합니다. 아래는 캐릭터 스킨 등록 과정입니다.
...
라플 티켓은 MMOC로 구매하고 참여할 수 있습니다. 해당 응모 기간 동안 참여할 수 있으며, 추첨 결과에 당첨되면 당첨자에게 상품을 전달하는 기능이 구현되어 있습니다.
...
환전소에 입장하면 아래와 같은 팝업이 나타납니다.

|![1_L1Tq7QrjN9aQLcFyi3uYxg](https://github.com/mossland/mossverse/assets/13128375/e2bee313-9147-480c-9373-778c5ba92e1a)|
|:--:|
|*환전소 팝업*|
...
투표소에서는 제안된 투표 리스트에서 투표 제목을 누르면 안건 내용을 확인할 수 있으며,
