...
화면 왼쪽 하단에 위치한 드래그 버튼을 사용하여 캐릭터 이동을 조작합니다. 메타버스 내에서 특수 기능이 있는 건물 근처로 다가가면, 화면에 ‘Press’라는 안내 UI가 표시됩니다. 동시에, 오른쪽 하단에는 말머리 모양의 기능 활성화 버튼이 나타납니다. 이 버튼을 눌러 원하는 기능을 활성화할 수 있습니다.
